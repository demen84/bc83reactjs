export default function Phone(props) {
    ...
    const { phone, getPhoneDetails, handleAddCart } = props;
    ...
    return (
        <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
            <a href="#">
                ...
                <img className="rounded-t-lg" src={phone.hinhAnh} alt={phone.tenSP} />
            </a>
            <div className="p-5">
                <a href="#">
                ...
                {/* Nút Add to Cart */}
                <button type="button" className="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800" onClick={() => { handleAddCart(phone) }}>Add to cart</button>
            </div>
        </div>
    );
}
